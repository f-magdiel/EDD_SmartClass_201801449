...
function Login(){
    ...
    const enviarDatos = async (event) =>{
        ...
        data.map(function(dat){
            ...
            if (dat.tipo == "admin" && dat.bandera==true){
                                        ...
                                        <h2 className="fw-bold mb-2 text-uppercase">Login</h2>
                                            <p className="text-white-50 mb-5">Por favor ingrese su usuario  y contraseña</p>
                                                <div className="form-outline form-white mb-4">
                                                    <input type="text" id="typeUsuario" className="form-control form-control-lg" name="usuario" onChange={handleInputChange} />
                                                    <label className="form-label" htmlFor="typeEmailX">Usuario</label>
                                                </div>
                                                <div className="form-outline form-white mb-4">
                                                    <input type="password" id="typeContrasena" className="form-control form-control-lg" name="contraseña" onChange={handleInputChange} />
