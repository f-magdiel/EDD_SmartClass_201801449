...
class Nodo:
    def __init__(self, valor, x =None, y = None):
        self.x = x #posicion en cabecera horizontal
        self.y = y #posicion en cabecera vertical 
        self.valor = valor #valor a comparar
        self.derecho = None #enlace para mover hacia la derecha en la matriz
        self.izquierdo = None #enlace para mover hacia la izquierda en la matriz
        self.arriba = None #enlace para mover hacia arriba en la matriz
        self.abajo = None #enlace para mover hacia abajo en la matriz
        self.siguiente = None #enlace en la cabecera en x
        self.anterior = None #enlace en la cabecera en y
